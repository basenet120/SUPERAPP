            ...
            <>
              ...
              <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-dropdown border border-primary-200 py-2 z-20 animate-fade-in">
                <div className="px-4 py-3 border-b border-primary-100">
                  <p className="text-sm font-semibold text-primary-900">Alon Koppel</p>
                  <p className="text-xs text-primary-500">alon@basestudios.com</p>
                </div>
                <div className="py-1">
                ...
                <div className="border-t border-primary-100 py-1">
                  <button className="w-full px-4 py-2 text-left text-sm text-danger-600 hover:bg-danger-50 transition-colors">
                    Sign out
                  </button>
                </div>
              </div>
